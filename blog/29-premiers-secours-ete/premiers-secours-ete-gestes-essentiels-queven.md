---
title: "Premiers secours été : les gestes essentiels, pharmacie ou consultation ?"
description: "Coup de chaleur, coup de soleil, piqûre de méduse, de moustique, de tique, turista, œil rouge de piscine, mains-pieds-bouche, mélio : la fiche réflexe des gestes de l'été et la question qui guide tout : la pharmacie suffit-elle ou faut-il consulter ? Conseils de votre pharmacie à Quéven."
date: 2026-07-27
...
tags:
  ...
  - Morbihan
  - pharmacie
image: "infographie-premiers-secours-ete.png"
og_image: "og-29-premiers-secours-ete.jpg"
---

**L'essentiel en 3 points :**
- Notre triage tient en 3 questions: la personne est-elle consciente et cohérente? les symptômes sont-ils localisés ou généraux? combien de temps s'est-il écoulé? Ce sont elles qui décident entre conseil officinal et orientation vers le 15 ou les urgences.
- Trois signaux font toujours basculer vers la consultation: perte de connaissance ou confusion, réaction allergique généralisée (gonflement du visage, difficulté à respirer), et absence d'amélioration après 24 à 48 h de gestes simples.
- Les gestes qui changent tout: refroidir (coup de chaleur), règle des « 15 » (coup de soleil), eau de mer et jamais d'eau douce (méduse), tire-tique avant 24 h (tique), soluté de réhydratation orale (turista), position latérale de sécurité puis RCP (noyade).

---

# Premiers secours été: les gestes essentiels, pharmacie ou consultation?

Chaque été, les mêmes urgences reviennent à la pharmacie: coup de chaleur, coup de soleil, piqûre de méduse ou d'insecte, morsure de tique, turista, noyade évitée de peu. Plus discrets: l'œil rouge de piscine, les mains-pieds-bouche ou les démangeaisons après une baignade en eau douce. Cette fiche réflexe rassemble les gestes essentiels, ceux que vous avez peut-être déjà croisés dans nos fiches saisonnières, et y ajoute ce qui manquait, en gardant toujours la même question en tête: la pharmacie suffit-elle, ou faut-il consulter?
...
![Infographie premiers secours d'été: trousse de secours ouverte avec tire-tique, chlorhexidine, sels de réhydratation orale, gel apaisant, et les gestes essentiels par situation (coup de soleil, méduse, tique, turista, noyade, mains-pieds-bouche, mélio)](infographie-premiers-secours-ete.png)
...
> Vous détaillerez tous ces gestes dans notre fiche dédiée: [Coup de soleil: comment réagir et quand s'inquiéter ?](../26-coups-de-soleil/coups-de-soleil-prevenir-traiter-queven.html)
...
> Le protocole complet (eau de mer, retrait des tentacules, chaleur): [Méduses sur les plages bretonnes: que faire en cas de piqûre ?](../28-meduses-plages-bretonnes/meduses-plages-bretonnes-queven.html)
...
> Retrait pas à pas, signes à surveiller 30 jours, traitement du Lyme: [Tiques en Bretagne: piqûre, prévention et réaction](../25-tiques-bretagne/tiques-bretagne-prevention-reaction-queven.html)
...
> La logique d'hydratation derrière le geste: [Hydratation en été: au-delà de l'eau](../22-hydratation-ete/hydratation-ete-deshydratation-queven.html)
...
7. Croix-Rouge française & European Resuscitation Council (ERC), gestes de premiers secours: position latérale de sécurité, RCP (5 insufflations initiales en cas de noyade)
8. MSD Manuals, conjonctivite et œil rouge ; maladie main-pieds-bouche (entérovirus) ; dermatite cercarienne (« mélio »)
9. Santé publique France, infections à entérovirus et maladie mains-pieds-bouche chez le jeune enfant

> ⚠️ Sources à finaliser avant publication: les références ci-dessus nomment les autorités compétentes. Avant mise en ligne, ajouter les URL/fiches exactes (santepubliquefrance.fr, sante.gouv.fr, has-sante.fr, ameli.fr, ansm.sante.fr, msdmanuals.com) à la manière de la fiche tiques.
