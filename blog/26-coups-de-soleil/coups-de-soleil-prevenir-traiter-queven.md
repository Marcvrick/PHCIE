...
- Même sous un ciel breton couvert, jusqu'à 85% des UV traversent les nuages: un coup de soleil s'attrape sans soleil franc, en quelques minutes pour les peaux claires
- Le premier geste qui change tout, c'est de refroidir la peau avec de l'eau tempérée pendant un quart d'heure, avant même d'appliquer le moindre soin
- Chaque coup de soleil laisse une trace dans l'ADN de la peau: l'effet est cumulatif, et c'est pour ça que la prévention n'est jamais accessoire

---

# Coup de soleil: comment réagir et quand s'inquiéter?
...
Parlons franchement de ce qui se passe dans votre peau, des gestes qui soulagent vraiment, et de ceux qu'il vaut mieux oublier. Si le sujet vous intéresse en amont, nous avons aussi un article complet sur la <a href="../protection-solaire-printemps-bretagne-queven.html">protection solaire</a> dès les premiers rayons.
...
<div style="background: linear-gradient(135deg, #F5F1E8 0%, #f0ebe0 100%); border-radius: 16px; padding: 28px; margin: 28px 0;">
  <h3 style="text-align: center; color: #1A1A1A; margin: 0 0 4px;">La règle des 15: le bon réflexe</h3>
  <p style="text-align: center; color: #7C9885; margin: 0 0 22px; font-size: 0.95em;">Le tout premier geste face à un coup de soleil</p>
  <div style="display: flex; flex-wrap: wrap; gap: 16px; justify-content: center;">
    <div style="flex: 1; min-width: 150px; text-align: center; background: #fff; border-radius: 12px; padding: 18px;">
      <div style="font-size: 2.2em; font-weight: 700; color: #2D5F5D;">15 °C</div>
      <div style="color: #1A1A1A; font-weight: 600;">Eau tempérée</div>
      <div style="color: #7C9885; font-size: 0.85em;">Ni glace, ni eau glacée</div>
    </div>
    <div style="flex: 1; min-width: 150px; text-align: center; background: #fff; border-radius: 12px; padding: 18px;">
      <div style="font-size: 2.2em; font-weight: 700; color: #2D5F5D;">15 min</div>
      <div style="color: #1A1A1A; font-weight: 600;">Durée</div>
      <div style="color: #7C9885; font-size: 0.85em;">Pour calmer l'inflammation</div>
    </div>
    <div style="flex: 1; min-width: 150px; text-align: center; background: #fff; border-radius: 12px; padding: 18px;">
      <div style="font-size: 2.2em; font-weight: 700; color: #2D5F5D;">15 cm</div>
      <div style="color: #1A1A1A; font-weight: 600;">Distance</div>
      <div style="color: #7C9885; font-size: 0.85em;">Pommeau de douche à distance</div>
    </div>
  </div>
  <p style="text-align: center; color: #7C9885; font-size: 0.82em; margin: 20px 0 0;">Eau tempérée, jamais glacée: le froid extrême resserre les vaisseaux et peut aggraver la lésion.</p>
</div>
...
Deux pièges à éviter: la vaseline, qui emprisonne la chaleur, et les crèmes anesthésiantes (benzocaïne, lidocaïne), qui peuvent déclencher des allergies de contact. Pensez aussi à boire: une brûlure étendue fait perdre de l'eau et favorise la <a href="../22-hydratation-ete/hydratation-ete-deshydratation-queven.html">déshydratation</a>.

---

**Coup de soleil, peau qui tiraille, ou besoin d'un bon SPF avant le départ?**
Passez nous voir. On regarde ensemble votre type de peau et on choisit le soin adapté, sans rendez-vous.
32 Place de Toulouse, Quéven

---

## Quels soins choisir en pharmacie?
...
3. VIDAL / ANSM. Biafine (trolamine): indication brûlures superficielles et coups de soleil, conditions d'emploi
...
7. Météo / indices UV. Pénétration de 85% des UV à travers les nuages, indice UV estival en Bretagne
8. Journal of Ethnopharmacology. Propriétés anti-inflammatoires de l'aloe vera (preuves cliniques encore limitées)
9. Universimed / dermatologie. Biologie moléculaire du coup de soleil: inflammasome NLRP1, IL-1β, mutations signature UV
