# Guide de Rédaction - Blog Pharmacie Charnal
...
### 1. Titre (H1)
- Clair et descriptif
- Inclut la localisation pour le SEO local : "à Quéven" ou "en Bretagne"
- Maximum 60 caractères pour Google
- Exemple : "Prévenir les maux de l'hiver à Quéven"

### 2. Chapeau (Introduction)
- 2-3 phrases maximum
- Ton accueillant et rassurant
- Personnaliser avec "les conseils de Laure" quand approprié
- Poser une question si pertinent : "Vous vous demandez comment..."
- Exemple : "Le froid s'installe en Bretagne et vous vous demandez comment passer l'hiver sereinement ? Voici les conseils de Laure pour prendre soin de vous et de votre famille."

### 3. Corps de l'Article

**Structure en H2 et H3 :**
```markdown
...
**Longueur idéale :**
- Article complet : 1000-1500 mots (optimal pour SEO)
...
<div class="highlight-box">
    <p><strong>💡 Bon à savoir</strong> : Message rassurant avec lien vers service si pertinent.</p>
</div>
```

**Utiliser :**
- "💡 Bon à savoir" (neutre, informatif)
- "⚠️ Important" (mise en garde nécessaire)
- Éviter : "Conseil de votre pharmacien" (trop promotionnel)

**Listes à puces :**
- Pour les conseils pratiques
- Pour les symptômes
- Pour les étapes d'un processus
- Maximum 7 items par liste

**Section FAQ (obligatoire pour SEO) :**
- 3-5 questions fréquentes
- Réponses courtes et précises (2-3 phrases)
- Utiliser un langage naturel comme les vraies questions des patients
...
**Vers les pages existantes uniquement :**
- [Services](../services-v2.html) - produits naturels, vaccination, etc.
- [Contact](../contact-v2.html) - pour prise de rendez-vous
- Autres articles de blog (quand ils existent)

**Comment créer un lien :**
```html
<a href="../services-v2.html" style="color: var(--teal); text-decoration: underline;">produits naturels</a>
```

### Mentions de Services

✅ **Subtil et naturel :**
- "Si vous préférez les solutions naturelles, nous proposons une gamme de produits de phytothérapie."
- "Sachez que vous pouvez vous faire vacciner directement à la pharmacie."
- "N'hésitez pas à passer nous voir pour des conseils personnalisés."

❌ **Trop vendeur :**
- "Découvrez notre exceptionnelle gamme de produits naturels !"
- "La Pharmacie Charnal est spécialiste de la phytothérapie."
- "Profitez de nos services de vaccination de qualité supérieure."

### Répétition du Nom

**Règle d'or :** Les lecteurs sont déjà sur le site de la Pharmacie Charnal. Pas besoin de le répéter.

✅ **Une seule fois :**
- Dans le titre de page (automatique via template)
- Dans la navigation (automatique)
- Dans le footer (automatique)

❌ **Éviter :**
- "À la Pharmacie Charnal, nous..."
- "La Pharmacie Charnal de Quéven propose..."
- "Votre Pharmacie Charnal..."
...
**Pour chaque article, identifier :**

1. **Mot-clé principal** (1 fois dans H1, 2-3 fois dans le contenu)
   - Exemple : "prévenir maux hiver"

2. **Mots-clés secondaires** (2-3 fois chacun)
   - Exemple : "rhume", "grippe", "infections hivernales"

3. **Mots-clés locaux** (obligatoire)
   - "Quéven" : 2-3 fois minimum
   - "Bretagne" : 1-2 fois si pertinent
   - "56530" : dans coordonnées si mentionnées

4. **Mots-clés longue traîne** (questions naturelles)
   - Exemple : "comment éviter le rhume en hiver"
   - À utiliser dans les titres H2/H3 et FAQ

### Éléments SEO Obligatoires

**Meta description (160 caractères max) :**
```html
<meta name="description" content="Les conseils de Laure, votre pharmacienne à Quéven, pour [sujet]. [Bénéfice concret]. [Mots-clés importants].">
```

**Title (60 caractères max) :**
```html
<title>[Sujet] | Conseils Pharmacien Quéven | Pharmacie Charnal</title>
```

**Structure des titres :**
- 1 seul H1 (titre principal)
- 4-6 H2 (sections principales)
- 2-4 H3 par H2 (sous-sections)
- Toujours inclure des mots-clés dans H2/H3

**Section FAQ :**
- Questions formulées naturellement (comme Google Assistant)
- Réponses courtes (50-100 mots)
- Vise les Featured Snippets Google

### Densité de Mots-clés

**Règle :** 1-2% de densité pour mot-clé principal

Pour un article de 1000 mots :
- Mot-clé principal : 10-20 fois
- Mots-clés secondaires : 5-10 fois chacun
- Variations naturelles encouragées
...
- [ ] Ton rassurant et sincère (pas alarmiste)
- [ ] Pas de répétitions de "Pharmacie Charnal"
- [ ] Personnalisation avec "Laure" si approprié
...
- [ ] 1 H1 avec mot-clé principal et localisation
- [ ] 4-6 H2 avec mots-clés secondaires
...
- [ ] Mots-clés locaux présents (Quéven, Bretagne)
- [ ] Mots-clés principaux dans H1, H2, premiers paragraphes
- [ ] Questions naturelles dans FAQ
- [ ] Longueur 1000-1500 mots

### Liens

- [ ] Liens internes vers services existants uniquement
- [ ] Liens naturellement intégrés (pas forcés)
- [ ] Lien vers contact si pertinent
- [ ] Pas de liens cassés

### Mise en Forme

- [ ] Boxes de conseils avec "💡 Bon à savoir"
...
Format : `sujet-principal-queven.html`

Exemples :
- `prevenir-maux-hiver-queven.html`
- `proteger-peau-hiver-queven.html`
- `vaccination-grippe-queven.html`
...
└── blog/
    ├── prevenir-maux-hiver-queven.html
    ├── proteger-peau-hiver-queven.html
    └── [autres-articles].html
```

### Mise à Jour du Blog

Après avoir créé l'article, mettre à jour `blog-v2.html` :

```html
<article class="blog-card fade-up">
    <div class="blog-image-placeholder">[emoji]</div>
    <div class="blog-content">
        <span class="blog-date">[Date]</span>
        <h2 class="blog-title">[Titre]</h2>
        <p class="blog-excerpt">
            [Résumé en 1-2 phrases]
        </p>
        <a href="blog/[nom-fichier].html" class="blog-link">
...
- Ton rassurant dès l'intro : "Pas besoin de mesures extraordinaires"
- Personnalisation : "les conseils de Laure"
- Pas de répétition du nom de la pharmacie
- FAQ bien structurée
...
## 📸 Photos Blog & GMB — Règles de Prompt

### Format et cadrage
- **Format carré (1:1)** — toujours, pour blog et GMB
- **Wide shot** — les sujets occupent ~50-60% du cadre, jamais plus
- **Espace négatif généreux** tout autour des sujets (haut, bas, côtés)
- **Shallow depth of field** sur le fond — crée la profondeur et évite un rendu plat/agressif

### Fond
- **Fond gris studio minimaliste** (light grey) — cohérent sur tous les posts
- Pas de décor réaliste (cuisine, salle de bain, etc.) qui casse l'esthétique studio

### Texte visible
- Si un produit ou objet contient du texte (étiquette, packaging, bouteille), **tout texte doit être en français**

### Exemple de structure de prompt
```
Square format (1:1). Studio photography, wide shot with plenty of negative space around the subjects. Minimalist light grey background. [Description des sujets, action, émotion]. Subjects centered in the frame, occupying only about 50-60% of the image, with generous empty space on all sides. Shallow depth of field on the background. Clean, bright aesthetic with soft studio lighting. [Vêtements/couleurs]. If any product or object with text is visible (label, packaging, bottle), all text must be written in French. Sharp focus on subjects, high-quality commercial stock photo style. [Concept/mood].
```

---

## 🖼 Images OG (Open Graph) — Partage Social

### Pourquoi
Quand un lien est partagé sur LinkedIn, Facebook, Twitter ou WhatsApp, la plateforme affiche une preview visuelle. Sans image OG dédiée, c'est le petit logo qui s'affiche au lieu d'une belle carte plein format.

### Specs
- **Dimensions :** 1200×630px (ratio 1.91:1) — standard Open Graph
- **Format :** JPEG, quality 90, < 100KB
- **Emplacement :** `images/Blog photos/OG generated/og-[nom].jpg`

### Workflow
1. **Générer l'image OG** : double-cliquer `images/Blog photos/Lancer OG Converter.command` (ou via le skill blog, étape 8)
2. Le converter recadre automatiquement avec **détection de visages** (OpenCV) pour ne jamais couper les têtes
3. L'image originale (carrée 1:1) reste inchangée dans le corps de l'article
4. **Dans le HTML** de l'article, déclarer l'image OG dans le `<head>` :

```html
<meta property="og:image" content="https://www.pharmaciecharnal.com/images/Blog%20photos/OG%20generated/og-[slug].jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
```

### Converter
- **Script :** `images/og_converter.py` (Streamlit + PIL + OpenCV)
- **Lanceur :** `images/Blog photos/Lancer OG Converter.command` (double-clic)
- **Output :** `images/Blog photos/OG generated/`
- Peut aussi être appelé programmatiquement depuis le skill blog (`from og_converter import smart_crop_to_og`)
