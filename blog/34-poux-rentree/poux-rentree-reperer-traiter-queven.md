...
tags:
  ...
  - Quéven
  - Bretagne
image: "blog-38-poux-rentree.jpg"
og_image: "og-38-poux-rentree.jpg"
---
...
Dans les écoles de Quéven comme partout ailleurs, les poux reviennent chaque année en septembre et octobre, dès que les classes se mélangent à la cantine et à la récréation. La question qu'on pose toujours en premier, chez nous: avez-vous vu un pou vivant, ou seulement entendu dire qu'il y en avait dans la classe?

## Comment repérer un pou vivant sur la tête de mon enfant?

Un pou adulte mesure 2 à 4 mm, ne saute pas et ne vole pas: il se déplace uniquement de cheveu en cheveu, par contact direct (Ameli, 2025). Environ 40% des enfants infestés ne se grattent pas du tout. Le seul diagnostic fiable est le peignage à la lumière, nuque et derrière les oreilles, pas une suspicion.
...
<div class="illus">
<div class="illus-title">Trois méthodes maison qui ne marchent pas</div>
<div class="illus-sub">D'après le CDC, Ameli et l'étude Takano-Lee (2004)</div>
<div class="warning-cards">
<div class="warning-card wc-1">
...
<div class="wcard-tag">Mayonnaise, bonnet toute la nuit</div>
<div class="wcard-title">Aucune preuve d'efficacité</div>
<p class="wcard-desc">Idem pour l'huile, le beurre et la vaseline. Une nuit perdue pendant que les lentes éclosent.</p>
</div>
<div class="warning-card wc-2">
<div class="wcard-icon">
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c4 0 8 2.5 8 6 0 1-1 2-2 2H6c-1 0-2-1-2-2 0-3.5 4-6 8-6z"/><path d="M12 11v8"/><path d="M9 19h6"/></svg>
</div>
<div class="wcard-tag">Vinaigre</div>
<div class="wcard-title">Ne tue pas les poux</div>
<p class="wcard-desc">Aide tout au plus à décoller les lentes avant le passage du peigne, rien de plus.</p>
</div>
<div class="warning-card wc-3">
<div class="wcard-icon">
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c4 0 8 2.5 8 6 0 1-1 2-2 2H6c-1 0-2-1-2-2 0-3.5 4-6 8-6z"/><path d="M12 11v8"/><path d="M9 19h6"/></svg>
</div>
<div class="wcard-tag">Huiles essentielles</div>
<div class="wcard-title">Efficacité non démontrée, contre-indiquées</div>
<p class="wcard-desc">Chez l'enfant et pendant la grossesse, l'allergie est un risque réel pour un bénéfice non prouvé.</p>
</div>
</div>
<div class="illus-foot">Le seul geste utile en complément d'un traitement: le peigne à dents métalliques.</div>
</div>
...
![Infographie: repérer un pou vivant, le protocole de traitement en 2 applications, la résistance aux pyréthrinoïdes, et ce qui ne marche pas (mayonnaise, vinaigre, huiles essentielles), Pharmacie Charnal Quéven](infographie-poux-rentree.png)
...
| Suspicion, aucun pou vu | Peignage minutieux à la lumière avant tout traitement | Votre pharmacien |
