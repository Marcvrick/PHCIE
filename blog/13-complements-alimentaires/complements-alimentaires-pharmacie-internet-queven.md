---
title: "Compléments alimentaires : pharmacie ou internet ? Ce que votre pharmacien vérifie pour vous"
description: "Pharmacie ou internet pour vos compléments alimentaires ? Les différences concrètes, les risques documentés et les critères pour choisir en toute sécurité à Quéven."
date: 2026-04-08
...
tags:
  ...
  - Quéven
  - Bretagne
image: "infographie-complements-alimentaires.png"
og_image: "og-13-complements-alimentaires-internet.jpg"
---
...
## Le marché explose: et le contrôle suit mal
...
![Infographie: compléments alimentaires, pharmacie ou internet, chiffres clés DGCCRF, ANSES et biodisponibilité](infographie-complements-alimentaires.png)
...
## Vitamines, magnésium, oméga-3, probiotiques: les pièges concrets
...
<div style="background: linear-gradient(135deg, #faf8f5 0%, #f0ebe0 100%); border-radius: 16px; padding: 32px; margin: 32px 0; font-family: 'DM Sans', sans-serif;">
  <h3 style="text-align: center; color: #2D5F5D; margin-bottom: 8px; font-size: 1.1rem;">Pharmacie vs marketplace généraliste</h3>
  <p style="text-align: center; color: #888; font-size: 0.85rem; margin-bottom: 28px;">5 critères essentiels</p>
  <div style="display: flex; flex-direction: column; gap: 16px;">
    <div>
      <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 0.85rem; color: #444;">
        <span>Conseil personnalisé & interactions</span>
        <span style="color: #888;">Pharmacie ✅ | Amazon ❌</span>
      </div>
      <div style="display: flex; gap: 6px; height: 12px; border-radius: 6px; overflow: hidden;">
    ...
    <div>
      <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 0.85rem; color: #444;">
        ...
        <span style="color: #888;">Pharmacie ✅ | Amazon ⚠️</span>
      </div>
      <div style="display: flex; gap: 6px; height: 12px; border-radius: 6px; overflow: hidden;">
        <div style="width: 80%; background: #50A686; border-radius: 6px 0 0 6px;"></div>
        <div style="width: 20%; background: #e8e8e8; border-radius: 0 6px 6px 0;"></div>
      </div>
    </div>
    <div>
      <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 0.85rem; color: #444;">
        <span>Conformité réglementaire France</span>
        <span style="color: #888;">Pharmacie ✅ | Amazon ❌</span>
      </div>
      <div style="display: flex; gap: 6px; height: 12px; border-radius: 6px; overflow: hidden;">
    ...
    <div>
      <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 0.85rem; color: #444;">
        <span>Risque de contrefaçon ou surdosage</span>
        <span style="color: #888;">Faible ✅ | Élevé ❌</span>
      </div>
      <div style="display: flex; gap: 6px; height: 12px; border-radius: 6px; overflow: hidden;">
        <div style="width: 10%; background: #2D5F5D; border-radius: 6px 0 0 6px;"></div>
        <div style="width: 90%; background: #e8a87c; border-radius: 0 6px 6px 0;"></div>
      </div>
    </div>
    <div>
      <div style="display: flex; justify-content: space-between; margin-bottom: 6px; font-size: 0.85rem; color: #444;">
        <span>Qualité garantie de la forme galénique</span>
        <span style="color: #888;">Pharmacie ✅ | Amazon ⚠️</span>
      </div>
      <div style="display: flex; gap: 6px; height: 12px; border-radius: 6px; overflow: hidden;">
        <div style="width: 85%; background: #50A686; border-radius: 6px 0 0 6px;"></div>
        <div style="width: 15%; background: #e8e8e8; border-radius: 0 6px 6px 0;"></div>
      </div>
    </div>
  </div>
  <p style="text-align: center; color: #888; font-size: 0.75rem; margin-top: 20px;">Sources: DGCCRF 2023-2024 · SYNADIET 2025 · Académie nationale de Pharmacie</p>
</div>
...
| Complément populaire (magnésium, vit. D) | Pharmacie ou e-pharmacie ARS | Privilégier les formes biodisponibles |
...
**Les compléments alimentaires vendus en pharmacie sont-ils remboursés ?**
Non, les compléments alimentaires ne sont pas remboursés par l'Assurance Maladie, sauf cas très spécifiques sur prescription médicale (fer, acide folique en grossesse). En revanche, certaines mutuelles proposent un remboursement partiel, vérifiez votre contrat. Le prix en pharmacie intègre le conseil et la traçabilité, ce qui justifie souvent l'écart avec internet.

**Peut-on prendre plusieurs compléments en même temps ?**
Oui, mais pas sans réflexion. Les interactions existent entre compléments eux-mêmes: excès de zinc, par exemple, peut bloquer l'absorption du cuivre. Certaines associations sont bénéfiques (magnésium + vitamine B6, vitamine D + K2), d'autres à éviter. Dès que vous combinez plus de deux produits, un avis pharmaceutique est utile, nous y consacrons quelques minutes sans rendez-vous.

**Comment reconnaître une e-pharmacie sûre ?**
Le seul signe fiable est le logo commun européen (croix verte fond blanc, drapeau français), qui doit renvoyer vers la liste officielle ANSM des pharmacies en ligne autorisées. Sans ce logo, le site n'est pas une pharmacie au sens légal, quelle que soit son apparence professionnelle.

**La mention "naturel" garantit-elle la sécurité d'un complément ?**
Non. Le terme "naturel" n'a aucune définition réglementaire précise pour les compléments alimentaires. Certaines plantes naturelles sont hépatotoxiques à haute dose (curcuma, valériane). "Naturel" ne signifie ni inoffensif, ni sans interaction, ni bien dosé.

**Que faire si on a acheté un complément en ligne et qu'on a des effets indésirables ?**
Arrêtez le produit et consultez. Si l'effet persiste, rendez-vous chez votre médecin. Nous pouvons aussi déclarer l'effet indésirable à l'ANSES via le dispositif Nutrivigilance, chaque signalement contribue à la surveillance nationale et protège d'autres consommateurs.

---

**Références :**

1. SYNADIET, Observatoire 2025 et chiffres du marché français: 3 Md EUR CA, 61% de consommateurs, pharmacie 55% du marché, internet 11%
2. DGCCRF, Enquête compléments alimentaires 2023: un tiers des 270 établissements contrôlés présentaient des anomalies ; sanctions 2024: 2 356 amendes, 92,9 M EUR
3. OSAV / Canton de Fribourg (FR.ch), Campagne 2024 sur 127 compléments alimentaires achetés en ligne: 113 interdits à la vente (89%) pour ingrédients dangereux ou non autorisés ; 1 boutique sur 5 non déclarée
4. Mohn ES et al., *Nutrients* 2019, 11(10), 2466: 49% de risque d'interaction médicament-complément chez les patients sous tétracyclines, diurétiques thiazidiques ou ARA II
5. ANSES, Rapport Nutrivigilance 2023-2024: 749 déclarations d'effets indésirables en 2023, dont 6% graves ; alertes vitamine D (nourrissons), levure de riz rouge, curcuma
6. Ministère de la Santé, sante.gouv.fr: mise en garde explicite sur les compléments achetés hors UE (provenance, authenticité, composition, qualité non garanties)
7. Règlement européen CE 1924/2006, Allégations nutritionnelles et de santé: liste des allégations autorisées, interdiction des allégations thérapeutiques
8. Décret 2006-352 / DGAL Compl'Alim, Obligation de déclaration préalable pour tout complément alimentaire mis sur le marché en France
9. DGCCRF, Bilan 2024: 2 356 amendes administratives pour 92,9 M EUR tous secteurs confondus ; enquête compléments alimentaires 2023: un tiers d'anomalies parmi 270 établissements contrôlés

---

**Article précédent :** [Troubles du sommeil: les solutions naturelles pour retrouver des nuits sereines](troubles-sommeil-solutions-naturelles-queven.html)
